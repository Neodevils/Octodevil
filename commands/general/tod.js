module.exports = [
  {
    ...
    prototype: 'slash',
    code: `
$interactionReply[;{newEmbed:{title:Truth or Dare :3?}{description:$randomText[Hewwo;Hiii;Hellooo] *!* You got two options to pick. . . 

$customEmoji[kaeruEye] **truth**
***or***
$customEmoji[kaeruFire] **dare**}{color:$getVar[brownHex]}{footer:pick $randomText[truth;dare] 👀}{thumbnail:$userAvatar[$clientID]}};{actionRow:{selectMenu:tod:truth or dare. . . :1:1:no:{selectMenuOptions:๑ truth:tod0:humm... no lies okay?:false:<:kaeruEye:968520559472300032>}{selectMenuOptions:๑ dare:tod1:if you dare hhh:false:<:kaeruFire:968503004720418877>}}}]
		`
	},
  {
		name: "tod",
