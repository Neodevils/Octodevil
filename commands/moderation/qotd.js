module.exports = {
  ...
  $onlyForRoles[$getVar[staff];{"content":"$nonEscape[$customEmoji[git_alert]] Not allowed to use it. Okay, asking you the question. Are you staff on this server?","ephemeral": "true", "options": {"interaction": true}}]
  `
}
