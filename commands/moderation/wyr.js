module.exports = {
  ...
  $onlyForRoles[$getVar[owner];$getVar[staff];{"content":"$nonEscape[$customEmoji[git_alert]] Not allowed to use it. Gonna cry or swear...","ephemeral": "true", "options": {"interaction": true}}]
  `
}
