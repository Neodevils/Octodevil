module.exports = [
  ...
  },
  {
    ...
    $interactionReply[
    ;$nonEscape[$if[$getGlobalUserVar[randomString]==$textInputValue[commissionInput];{newEmbed:{title:$customEmoji[mnsVerified] \`$textInputValue[commissionInput]\`}{description:$customEmoji[mnsToken] × $randomText[100;100;100;100;100;100;100;100;400;400;400;400;1200;1200;1200] AKI Tokens sent to your account. ヾ(〃^∇^)ﾉ}{color:$getVar[invisibleHex]}{image:https://media.discordapp.net/attachments/861208192121569280/981529632639684658/kaeru_n_octadex_commission.gif}{footer:Let's leave everything to Octadex 𖤪}};{newEmbed:{title: $customEmoji[mnsImportant] \`$textInputValue[commissionInput]\` was wrong...}{description:㏒ — No tokens received in this commission. (╯•﹏•╰)}{color:$getVar[gitHex]}{image:https://media.discordapp.net/attachments/861208192121569280/981558017369718804/kaeru_error.gif}{footer:We should not fail Octadex...}}]]
