module.exports = ({
  ...
  $apiMessage[$if[$slashOption[channel]==;$channelID;$if[$channelType[$if[$slashOption[channel]==;$channelid;$slashOption[channel]]]==text;$slashOption[channel];$channelID]];;{newEmbed:
    ...
    {description:$slashOption[description] }{color:$if[$slashOption[color]==;$getVar[invisibleHex];$if[$isValidHex[$slashOption[color]]==true;$slashOption[color];$getVar[invisibleHex]]]}
  ...
  {"content":"$nonEscape[$customEmoji[git_alert]] Fifth option description reached max character. \\n> \`The limit is 30 characters.\`",
    "ephemeral":"true",
    "options":{"interaction":true}
  }]
  ...
  {"content":"$nonEscape[$customEmoji[git_alert]] The fifth role provided doesn't exists.",
    "ephemeral":"true",
    "options":{"interaction":true}
  }]
  ...
  $onlyIf[$splitText[9]!=;
  {"content":"$nonEscape[$customEmoji[git_alert]] You need to provide a fifth role.",
    "ephemeral":"true",
    "options":{"interaction":true}
  }]
  ...
  {"content":"$nonEscape[$customEmoji[git_alert]] [5] There is matching role ids.",
    "ephemeral":"true",
    "options":{"interaction":true}
  }]
