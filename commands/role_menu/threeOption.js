...
$nonEscape[$if[$isCustomEmoji[$nonEscape[$customEmoji[$advancedTextSplit[$arrayAt[emoji;3];:;2]]]]==false;$nonEscape[$customEmoji[2xz]];$if[$arrayAt[emoji;3]==;$nonEscape[$customEmoji[2xz]];$nonEscape[$customEmoji[$advancedTextSplit[$arrayAt[emoji;3];:;2]]]]]]}}}]
$wait[1s]
